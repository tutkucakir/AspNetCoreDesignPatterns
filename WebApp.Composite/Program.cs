...
namespace BaseProject
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            {
                var newUser = new AppUser() { UserName = "user1", Email = "user1@tutkucakir.com.tr" };
                userManager.CreateAsync(newUser, "Password12*").Wait();

                userManager.CreateAsync(new AppUser() { UserName = "user2", Email = "user2@tutkucakir.com.tr" }, "Password12*").Wait();
                userManager.CreateAsync(new AppUser() { UserName = "user3", Email = "user3@tutkucakir.com.tr" }, "Password12*").Wait();
                userManager.CreateAsync(new AppUser() { UserName = "user4", Email = "user4@tutkucakir.com.tr" }, "Password12*").Wait();
                userManager.CreateAsync(new AppUser() { UserName = "user5", Email = "user5@tutkucakir.com.tr" }, "Password12*").Wait();
                ...
                var subCategory4 = new Category { Name = "Polisiye Romanlarý 1.1", ReferenceId = subCategory3.Id, UserId = newUser.Id };
